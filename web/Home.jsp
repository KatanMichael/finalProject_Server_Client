...
<html lang="en">
  ...
  <head>
    ...
    <link href="vendor/bootstrap-social/assets/css/docs.css" rel="stylesheet" />
  ...
  <body id="page-top">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">See which classes we have here at GymApp</h3>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted"> Check out our pictures from the gym! </h3>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4 col-sm-6 portfolio-item">
            ...
            <div class="portfolio-caption">
              <h4>Pilates</h4>
              <p class="text-muted">Stretch that back</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            ...
            <div class="portfolio-caption">
              <h4>KickBox</h4>
              <p class="text-muted">Fight like a man</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            ...
            <div class="portfolio-caption">
              <h4>Zumba</h4>
              <p class="text-muted">Dance Baby Dance</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            ...
            <div class="portfolio-caption">
              ...
              <p class="text-muted">You can do this</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            ...
            <div class="portfolio-caption">
              <h4>Burning Fat</h4>
              <p class="text-muted">Ain't nothin' like it</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 portfolio-item">
            ...
            <div class="portfolio-caption">
              <h4>Spinning</h4>
              <p class="text-muted">Ride them hard</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            ...
            <h3 class="section-subheading text-muted">We Wanna hear what you've gotta say</h3>
          </div>
        </div>
        <div class="row">
          <div class="col-lg-12">
    ...
    <section id="signin">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading text-uppercase">Sign In With</h2>
                    <!-- <h3 class="section-subheading text-muted">We Wanna hear what you've gotta say</h3> -->
              ...
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <p>
                    ...
                    (not a therapy) when properly manifested.
                    <br/>
                    ...
                    <br/>
                    Pilates' system allows for different exercises to be modified in range of difficulty from beginner to advanced or to any other level,
              ...
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <p>
                    ...
                    <br/>
                    Historically, kickboxing can be considered a hybrid martial art formed from the
                    combination of elements of various traditional styles. This approach became increasingly
                    popular since the 1970s, and since the 1990s, kickboxing has contributed to the
              ...
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <p>
                    ...
                    The choreography incorporates hip-hop, soca, samba, salsa, merengue and mambo.
                    Squats and lunges are also included.
                    <br/>
                    Zumba classes are typically about an hour long and are taught by instructors
                    licensed by Zumba Fitness, LLC.
                    In one Zumba class, a person can burn up to 600 calories, depending on the
                    energy put forth.
                    <br/>
              ...
              <div class="col-lg-8 mx-auto">
                <div class="modal-body">
                  ...
                  <p>
                    ...
                    responsible for generating the energy our cells need to do their jobs. Exercise has been shown to
